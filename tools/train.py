...
def main():
    ...
    # save_dir = r'F:\Guntran\logs' + '\\' + model_cfg.get('backbone').get('type') + '\\' + dirname
    ...
    if args.split_validation:
        ...
        test_annotations    = 'datas/val.txt'
    ...
    if args.resume_from:
        ...
        shutil.copyfile(__file__, os.path.join(save_dir, os.path.basename(__file__)))  # 将当前运行的 Python 文件复制到保存目录中
